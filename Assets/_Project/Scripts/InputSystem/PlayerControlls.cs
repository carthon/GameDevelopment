...
public class PlayerControlls : IInputActionCollection, IDisposable {
    ...
    ""controlSchemes"": []
        ...
        // PlayerSpaceMovement
        m_PlayerSpaceMovement = asset.FindActionMap("PlayerSpaceMovement", true);
        m_PlayerSpaceMovement_Movement = m_PlayerSpaceMovement.FindAction("Movement", true);
        m_PlayerSpaceMovement_Camera = m_PlayerSpaceMovement.FindAction("Camera", true);
        // PlayerActions
        m_PlayerActions = asset.FindActionMap("PlayerActions", true);
        m_PlayerActions_Roll = m_PlayerActions.FindAction("Roll", true);
        m_PlayerActions_RB = m_PlayerActions.FindAction("RB", true);
        m_PlayerActions_RT = m_PlayerActions.FindAction("RT", true);
        m_PlayerActions_PickItem = m_PlayerActions.FindAction("PickItem", true);
        m_PlayerActions_Jump = m_PlayerActions.FindAction("Jump", true);
        // UIActions
        m_UIActions = asset.FindActionMap("UIActions", true);
        m_UIActions_PlayerOverview = m_UIActions.FindAction("PlayerOverview", true);
        m_UIActions_HotbarInput = m_UIActions.FindAction("HotbarInput", true);
        m_UIActions_EquipLeftHand = m_UIActions.FindAction("EquipLeftHand", true);
        m_UIActions_DropItem = m_UIActions.FindAction("DropItem", true);
        // Camera
        m_Camera = asset.FindActionMap("Camera", true);
        m_Camera_OrbitalView = m_Camera.FindAction("OrbitalView", true);
        m_Camera_SwapPersonCamera = m_Camera.FindAction("SwapPersonCamera", true);
    }
    ...
    public struct PlayerSpaceMovementActions {
        private readonly PlayerControlls m_Wrapper;
    ...
    public struct PlayerActionsActions {
        ...
        public void SetCallbacks(IPlayerActionsActions instance) {
            if (m_Wrapper.m_PlayerActionsActionsCallbackInterface != null) {
                ...
                PickItem.started -= m_Wrapper.m_PlayerActionsActionsCallbackInterface.OnPickItem;
                PickItem.performed -= m_Wrapper.m_PlayerActionsActionsCallbackInterface.OnPickItem;
                PickItem.canceled -= m_Wrapper.m_PlayerActionsActionsCallbackInterface.OnPickItem;
    ...
    public struct CameraActions {
        ...
        public void SetCallbacks(ICameraActions instance) {
            if (m_Wrapper.m_CameraActionsCallbackInterface != null) {
                OrbitalView.started -= m_Wrapper.m_CameraActionsCallbackInterface.OnOrbitalView;
                OrbitalView.performed -= m_Wrapper.m_CameraActionsCallbackInterface.OnOrbitalView;
                OrbitalView.canceled -= m_Wrapper.m_CameraActionsCallbackInterface.OnOrbitalView;
                SwapPersonCamera.started -= m_Wrapper.m_CameraActionsCallbackInterface.OnSwapPersonCamera;
                SwapPersonCamera.performed -= m_Wrapper.m_CameraActionsCallbackInterface.OnSwapPersonCamera;
                SwapPersonCamera.canceled -= m_Wrapper.m_CameraActionsCallbackInterface.OnSwapPersonCamera;
            }
