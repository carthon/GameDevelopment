...
namespace _Project.Libraries.TextMesh_Pro.Examples___Extras.Scripts {
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour {
        ...
        private void OnDrawGizmos() {
            ...
            ObjectStats = "Characters: " + m_TextInfo.characterCount + "   Words: " + m_TextInfo.wordCount + "   Spaces: " + m_TextInfo.spaceCount + "   Sprites: " +
                m_TextInfo.spriteCount + "   Links: " + m_TextInfo.linkCount
        ...
        private void DrawLineBounds() {
            ...
            for (var i = 0; i < lineCount; i++) {
                ...
                var isLineVisible = lineInfo.characterCount == 1 && (firstCharacterInfo.character == 10 || firstCharacterInfo.character == 11 || firstCharacterInfo.character == 0x2028 ||
